document.addEventListener('DOMContentLoaded', () => {
  ...
  function moveOutcomes() {
    ...
    // snake getting to the red square
  ...
  function randomApple() {
    ...
    } while(squares[appleIndex].classList.contains('snake')) //making sure apples dont appear on the snake as the same red color and filling in as snake 
  ...
  function control(e) {
    ...
    if(e.keyCode === 39) {
      direction = 1 // arrows will produce movement --right
    } else if (e.keyCode === 38) {
      direction = -width // up
    } else if (e.keyCode === 37) {
      direction = -1 // left
    } else if (e.keyCode === 40) {
      direction = +width //downb
    }
  }
